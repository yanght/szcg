...
namespace bacgBL.zhpj
{
    public class PQAJ_Dealyl
    {
        ...
        public static DataSet GetXCYDataInfo(string UserCode,  string DataField, string DateStart, string DateEnd, string SearchYear, PageInfo page, out string ErrMsg)
        {
            ...
            try
            {
                using (bacgDL.zhpj.PQAJ_dealyl dl = new bacgDL.zhpj.PQAJ_dealyl())
                {
                    return dl.GetXCYataInfo(UserCode, DataField, DateStart, DateEnd, SearchYear, page);
                }
            }
            catch (Exception e)
            {
        ...
        #region GetZRDWDataInfo1：获取职能部门内部评价统计案卷的列表
        public static DataSet GetZRDWDataInfo2(string UserDefinedCode, string AreaCode, string AppriseType1, string AppriseType2, string DateStart, string DateEnd, PageInfo page, out string ErrMsg)
        {
            ...
            try
            {
                using (bacgDL.zhpj.PQAJ_dealyl dl = new bacgDL.zhpj.PQAJ_dealyl())
                {
                    return dl.GetZRDWDataInfo2(UserDefinedCode, AreaCode, AppriseType1, AppriseType2, DateStart, DateEnd, page);
                }
            }
            catch (Exception e)
            {
