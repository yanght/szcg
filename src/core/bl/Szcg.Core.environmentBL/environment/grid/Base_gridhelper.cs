...
namespace bacgBL.environment.grid
{
	/// <summary>
	...
	public class BASE_gridhelper
	{
		...
		**/
		...
		{
			ArrayList streets = new ArrayList(); 
			string sql = "select id,streetname from street where fid=" + areaId;
				SqlDataReader rs = DataAccess.ExecuteReader(sql, null);
		...
		**/
		...
		{
			ArrayList communitys = new ArrayList(); 
			string sql = "select id,commname from community where fid=" + streetId;
