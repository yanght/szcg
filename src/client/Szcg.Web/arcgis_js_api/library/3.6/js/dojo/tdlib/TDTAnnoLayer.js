define(["dojo/_base/declare", "esri/layers/tiled"], function (declare) {
    return declare(esri.layers.TiledMapServiceLayer, {
        constructor: function () {
            ...
            this.initialExtent = (this.initialExtent = new esri.geometry.Extent(120.4986047744751, 30.54224967956543, 121.002491855621338, 30.992860794067383, this.spatialReference));
        ...
        getTileUrl: function (level, row, col) {
            ...
            //else if (level < 21) {
            //    // debugger
            //    levelMapBZ = "JXEMAPANNO";
            //    return "http://220.191.220.90/JXEMAPANNO/service/wmts?SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&LAYER=" + levelMapBZ + "&FORMAT=image/png&TILEMATRIXSET=TileMatrixSet0&TILEMATRIX=" + level + "&TILEROW=" + row + "&STYLE=default" + "&TILECOL=" + col;
            //}
            else if (level < 21) {
                // debugger
