...
namespace Szcg.Web.Controllers
{
    public class ProjectController : BaseController
    {
        ...
        [HttpPost]
        public AjaxFxRspJson ProjectReport(Project project)
        {
        ...
        [HttpPost]
        public AjaxFxRspJson ProjectHandler(Project project)
        {
            AjaxFxRspJson ajax = ValidateProject(project);
        ...
        [HttpPost]
        public AjaxFxRspJson ProjectApproved(Project project)
        {
            AjaxFxRspJson ajax = ValidateProject(project);
        ...
        public AjaxFxRspJson GetDelProjectList(ProjectInfo projInfo, PageInfo pageInfo, string startTime, string endTime)
        {
            ...
            List<Project> list = svc.GetDealProjectList(projInfo, pageInfo, startTime, endTime);
        ...
        public AjaxFxRspJson GetProjectDetail(string projcode, int year, bool isend)
        {
            ...
            Project project = svc.GetProjectDetail(projcode, year, isend);
        ...
        /// <returns></returns>
        public AjaxFxRspJson ValidateProject(Project project)
        {
            AjaxFxRspJson ajax = new AjaxFxRspJson() { RspCode = 1 };
